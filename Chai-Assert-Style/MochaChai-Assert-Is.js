...
suite.skip('Test Suite: .skip() Exclude the test suite', () => {
    test('Test case: This is execluded', () => {
        assert.isOk(true);
    });
    test('Test case: This is also execluded', () => {
        assert.isOk(false);
    });
});

//.skip() or  Excluding Test Case from execution-------------------------------------------------
suite('Test Suite: .skip() Execlude the selected test cases', () => {
    test.skip('Test case: This is execluded', () => {
    });
    test('Test case: This is not execluded', () => {
    });
});

// // xit() Excluding Test Case from execution------------------------------------------------------
// suite('Test Suite: xit() Execlude the selected test cases', () => {
//     xtest('Test case: This is execluded', () => {
//     });
//     test('Test case: This is not execluded', () => {
//     });
// });
...
//.isOk(object, [message]) ----------------------------------------------------------------------
suite('Test Suite: isOk() Assert if the object is truthy', () => {

    test('Test case: Non zero number is a truthy', () => {
...
suite('Test Suite: isNotOk() Assert if the object is falsy', () => {
...
suite('Test Suite: .isAbove() Asserts valueToCheck is > valueToBeAbove.', () => {
    test('Test case: First number should be greater than second', () => {
...
suite('Test Suite: .isAtleast() Asserts valueToCheck is >= valueToBeAtLeast', () => {

    test('Test Case: First Number should be >= second number', () => {
...
suite('Test Suite: .isBelow() Asserts valueToCheck is < valueToBeBelow', () => {

    test('Test Case: First number should be less than Second number', () => {
...
suite('Test Suite: .isAtMost() Asserts valueToCheck is <= valueToBeBelow', () => {

    test('Test Case: First number should be less than or equal to Second number', () => {
...
// .isExtensible(object)-------------------------------------------------------------------------
suite('Test Suite: .isExtensible() Asserts that object is extensible (can have new properties added to it).', () => {
    ...
    test('Test Case: Check if Extensible', () => {
...
suite('Test Suite: .isNotExtensible() Asserts that object is not extensible..', () => {
    ...
    test('Test Case: Check if it is not Extensible', () => {
...
// .isSealed(object)-----------------------------------------------------------------------------
suite('Test Suite: .isSealed() Asserts that object is sealed (cannot add/remove properties).', () => {
    ...
    test('Test Case: Check if Sealed', () => {
...
// .isNotSealed(object)-------------------------------------------------------------------------
suite('Test Suite: .isNotSealed() Asserts that object is not Sealed..', () => {
...
// .isFrozen(object)-----------------------------------------------------------------------------
suite('Test Suite: .isFrozen() Asserts that object is frozen (cannot add or modify properties.)', () => {
    ...
    test('Test Case: Check if Frozen', () => {
...
// .isNotFrozen(object)-------------------------------------------------------------------------
suite('Test Suite: .isNotFrozen() Asserts that object is not frozen', () => {
    ...
    test('Test Case: Check if not Frozen', () => {
...
// .isEmpty(target)-----------------------------------------------------------------------------
suite('Test Suite: .isEmpty() Asserts that the target does not contain any values. ', () => {

    test('Test Case: Check if Empty', () => {
...
// .isNotEmpty(target)-------------------------------------------------------------------------
suite('Test Suite: .isNotEmpty() Asserts that the target contains values.', () => {
...
suite('Test Suite: .isTrue() Asserts that value is true.', () => {
    let result = true;
    test('Test case: Checks if the value is true', () => {
...
suite('Test Suite: .isNotTrue() Asserts that value is not true.', () => {
    let result = false;
    test('Test case: Checks if the value is true', () => {
...
suite('Test Suite: .isFalse() Asserts that value is false.', () => {
    let result = false;
    test('Test case: Checks if the value is false', () => {
...
suite('Test Suite: .isNotFalse() Asserts that value is not false.', () => {
    let result = true;
    test('Test case: Checks if the value is false', () => {
...
suite('Test Suite: .isNull() Asserts the value is null', () => {
    test('Test Case: Check if the value is null', () => {
...
suite('Test Suite: .isNotNull() Asserts the value is not null', () => {
    test('Test Case: Check if the value is not null', () => {
...
// .isNaN(value, [message])----------------------------------------------------------------------
suite('Test Suite: .isNaN() Asserts the value is NaN', () => {
    test('Test Case: Check if the value is isNaN', () => {
...
suite('Test Suite: .isNotNaN() Asserts the value is not NaN', () => {
    test('Test Case: Check if the value is not NaN', () => {
...
suite('Test Suite: .isUndefined() Asserts the value is undefined', () => {
    test('Test Case: Check if the value is undefined', () => {
...
suite('Test Suite: .isDefined() Asserts that value is not undefined.', () => {

    test('Test Case: Check if valid is not undefined', () => {
...
suite('Test Suite: .isFunction() Asserts that value is a function.', () => {
    let f1 = function () { };
    function f2() { }
    let o = {};
    test('Test Case: Check if this is a function', () => {
...
suite('Test Suite: .isNotFunction() Asserts that value is not a function.', () => {
    let f1 = function () { };
    let o = {};
    test('Test Case: Check if this is a function', () => {
...
suite('Test Suite: .isObject() Asserts that value is an object of type ‘Object’', () => {
    //The assertion does not match subclassed objects.
    let obj = { msg: "hello" };
    let str = "Hi";

    test('Test Case: Check if it is of type Object', () => {
...
suite('Test Suite: .isNotObject() Asserts that value is an object of type ‘Object’', () => {
    //The assertion does not match subclassed objects.
    let obj = { msg: "hello" };
    let str = "Hi";

    test('Test Case: Check if it is not of type Object', () => {
...
suite('Test Suite: .isArray() Asserts that value is an array', () => {
    ...
    test('Test Case: Check if it is Array', () => {
...
suite('Test Suite: .isNotArray() Asserts that value is not an array', () => {
    ...
    test('Test Case: Check if it is not an Array', () => {
...
suite('Test Suite: .isString() Asserts that value is a string.', () => {

    test('Test Case: Check if it is a String', () => {
...
suite('Test Suite: .isNotString() Asserts that value is not a string.', () => {

    test('Test Case: Check if it is not a String', () => {
...
suite('Test Suite: .isNumber() Asserts that value is Number.', () => {

    test('Test Case: Check if it is a Number', () => {
...
suite('Test Suite: .isNotNumber() Asserts that value is not a Number.', () => {

    test('Test Case: Check if it is not a Number', () => {
...
suite('Test Suite: .isFinite() Asserts that value is a finite number. Unlike .isNumber, this will fail for NaN and Infinity.', () => {

    test('Test Case: Check if it is a Finite Number', () => {
...
suite('Test Suite: .isBoolean() Asserts that value is a boolean.', () => {

    test('Test Case: Check if it is a Boolean', () => {
...
suite('Test Suite: .isNotBoolean() Asserts that value is not a boolean.', () => {

    test('Test Case: Check if it is not a Boolean', () => {
